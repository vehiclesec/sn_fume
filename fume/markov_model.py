...
#    # Connack
#    mm.state_connack.next = [mm.state_s2]
#    mm.state_connack.next_prob = [1]
#
# 
#
#    # Puback
#    mm.state_puback.next = [mm.state_s2]
#    mm.state_puback.next_prob = [1]
#
#    # Pubrec
#    mm.state_pubrec.next = [mm.state_s2]
#    mm.state_pubrec.next_prob = [1]
#
#    # Pubrel
#    mm.state_pubrel.next = [mm.state_s2]
#    mm.state_pubrel.next_prob = [1]
#
#    # Pubcomp
#    mm.state_pubcomp.next = [mm.state_s2]
#    mm.state_pubcomp.next_prob = [1]
#
#    # Subscribe
#    mm.state_subscribe.next = [mm.state_s2]
#    mm.state_subscribe.next_prob = [1]
#
#    # Suback
#    mm.state_suback.next = [mm.state_s2]
#    mm.state_suback.next_prob = [1]
#
#    # Unsubscribe
#    mm.state_unsubscribe.next = [mm.state_s2]
#    mm.state_unsubscribe.next_prob = [1]
#
#    # Unsuback
#    mm.state_unsuback.next = [mm.state_s2]
#    mm.state_unsuback.next_prob = [1]
#
#    # Pingreq
#    mm.state_pingreq.next = [mm.state_s2]
#    mm.state_pingreq.next_prob = [1]
#
#    # Pingresp
#    mm.state_pingresp.next = [mm.state_s2]
#    mm.state_pingresp.next_prob = [1]
#
#
#
#    # Auth
#    mm.state_auth.next = [mm.state_s2]
